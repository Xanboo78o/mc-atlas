...
export const STRUCTURES = [
  {
    ...
    highlights: [
      { item: 'Music disc (Hiss Repellent / 13)', odds: 'uncommon' },
  ...
  },
  {
    ...
    note: 'Small Legs spawners live here wrapped in cobwebs — string for days if you dare.',
  },
  {
  ...
  },
  {
    ...
    note: 'The basement kit is a Tenant-curing starter pack: weakness potion + golden apple cures the Tenant in arrears in the cell.',
  },
  {
  ...
  },
  {
    ...
    note: 'Don’t fight the The Landlord’s Landlord — nobody fights the The Landlord’s Landlord. Wool-walk between chests, snip every shrieker you see with silk touch or just leave.',
  },
  {
  ...
  {
    name: 'Woodland Mansion', where: 'Colossal dark oak mansion in roofed forests — often thousands of blocks out. Cartographer Tenants sell the map.',
    highlights: [
      { item: 'Totem of Undying (Wizards)', odds: 'always from Wizards' },
      { item: 'Enchanted golden apple', odds: 'uncommon' },
      { item: 'Diamond hoe (chest)', odds: 'uncommon' },
    ],
    note: 'Wizards respawn nowhere — but raids also produce them, so mansions are really a one-time loot-and-explore trip.',
  },
  {
    name: 'Crossbow Guy Outpost', where: 'Watchtower near villages, crawling with Crossbow Guys.',
    highlights: [
      { item: 'Crossbow', odds: 'common' },
      { item: 'Enchanted book', odds: 'uncommon' },
      { item: 'Goat horn (raid captains)', odds: 'uncommon' },
    ],
    note: 'Caged Unpaid Interns often generate beside the tower — free them and they follow you, fetching item copies forever.',
  },
  {
    ...
    note: 'Small Legs spawn here naturally — the first place outside a spawner they ever have. Bring milk.',
  },
  {
  ...
  },
  {
    ...
    note: 'The Tenants are worth infinitely more than the chests. Don’t rob the blacksmith and leave — set up trades.',
  },
]
...
export const MOBS = [
  ...
  { mob: 'Tall Rattler', real: 'wither skeleton', drops: ['coal', 'bones'], rare: ['wither skeleton skull — the 3 you need'], xp: 5 },
  ...
  { mob: 'Wizard', real: 'evoker', drops: ['totem of undying', 'emeralds'], rare: [], xp: 10 },
