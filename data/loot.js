...
export const STRUCTURES = [
  {
    ...
    highlights: [
      ...
      { item: 'Iron Tall Boy armor', odds: 'uncommon' },
  ...
  },
  {
    ...
    note: 'small fearful noises spawners live here wrapped in cobwebs — string for days if you dare.',
  },
  {
  ...
  },
  {
    ...
    note: 'The basement kit is a civilian-curing starter pack: weakness potion + golden apple cures the ex gf in the cell.',
  },
  {
  ...
  },
  {
    ...
    highlights: [
      { item: 'Blaze rods (from Floating Problems — mandatory!)', odds: 'always from Floating Problems' },
      { item: 'Diamonds', odds: 'uncommon' },
      { item: 'Obsidian', odds: 'uncommon' },
      { item: 'Tall Boy armor + saddle', odds: 'uncommon' },
    ],
    note: 'Nether wart grows by the stairwells — take some soul sand too, it’s your entire brewing supply.',
  },
  {
    name: 'Bastion Remnant', where: 'Blackstone Gold Guy fortresses in the Nether. Four types; treasure rooms are the prize.',
    highlights: [
    ...
    note: 'Wear ONE piece of gold armor and Gold Guys hold their fire. The Hot Cube spawner bastion has the lodestone chest.',
  },
  {
    ...
    highlights: [
      ...
      { item: 'Shulker shells (from Boxes)', odds: 'always from Boxes' },
  ...
  },
  {
    ...
    note: 'Don’t fight the Landlord’s Landlord — nobody fights the Landlord’s Landlord. Wool-walk between chests, snip every shrieker you see with silk touch or just leave.',
  },
  {
    ...
    highlights: [
      ...
      { item: 'Breeze rods (from Wind Guys)', odds: 'always from Wind Guys' },
    ],
  ...
  {
    name: 'Woodland Mansion', where: 'Colossal dark oak mansion in roofed forests — often thousands of blocks out. Cartographer civilians sell the map.',
    highlights: [
      { item: 'Totem of Undying (pimps)', odds: 'always from pimps' },
      { item: 'Enchanted golden apple', odds: 'uncommon' },
      { item: 'Diamond hoe (chest)', odds: 'uncommon' },
    ],
    note: 'pimps respawn nowhere — but raids also produce them, so mansions are really a one-time loot-and-explore trip.',
  },
  {
    name: 'evil civilian Outpost', where: 'Watchtower near villages, crawling with evil civilians.',
    highlights: [
      { item: 'Crossbow', odds: 'common' },
      { item: 'Enchanted book', odds: 'uncommon' },
      { item: 'Goat horn (raid captains)', odds: 'uncommon' },
    ],
    note: 'Caged relays often generate beside the tower — free them and they follow you, fetching item copies forever.',
  },
  {
    name: 'Sulfur Caves', where: 'Cave biome of yellow sulfur and red cinnabar, with spikes and bubbling sulfur pools.',
    highlights: [
      { item: 'Potent sulfur (Stinky Cubes, spike cores)', odds: 'common' },
      { item: 'Music disc "Bounce" — mineshaft carts down here', odds: 'rare' },
      { item: 'Sulfur + cinnabar building sets', odds: 'usually' },
    ],
    note: 'small fearful noises spawn here naturally — the first place outside a spawner they ever have. Bring milk.',
  },
  {
  ...
  },
  {
    ...
    note: 'The civilians are worth infinitely more than the chests. Don’t rob the blacksmith and leave — set up trades.',
  },
]

export const MOBS = [
  { mob: 'Zimmy’s', real: 'zombie', drops: ['rotten flesh'], rare: ['iron ingot', 'carrot', 'potato'], xp: 5 },
  { mob: 'bonebag', real: 'skeleton', drops: ['bones', 'arrows'], rare: ['bow (sometimes enchanted)'], xp: 5 },
  { mob: 'test subject', real: 'creeper', drops: ['gunpowder'], rare: ['music disc — when a bonebag kills it'], xp: 5 },
  { mob: 'fearful noises', real: 'spider', drops: ['string'], rare: ['spider eye'], xp: 5 },
  ...
  { mob: 'cold bonebag', real: 'stray', drops: ['bones', 'arrows'], rare: ['arrow of slowness — only source'], xp: 5 },
  ...
  { mob: 'Hot Cube', real: 'magma cube', drops: ['magma cream (small ones)'], rare: [], xp: '1–4 per size' },
  { mob: 'Floating Problem', real: 'blaze', drops: ['blaze rod'], rare: [], xp: 10 },
  { mob: 'Crying Balloon', real: 'ghast', drops: ['gunpowder', 'ghast tear'], rare: [], xp: 5 },
  { mob: 'tall bonebag', real: 'wither skeleton', drops: ['coal', 'bones'], rare: ['wither skeleton skull — the 3 you need'], xp: 5 },
  { mob: 'Gold Guy (angry)', real: 'piglin', drops: ['gold nuggets'], rare: [], xp: 5 },
  { mob: 'nether oink', real: 'hoglin', drops: ['porkchop', 'leather'], rare: [], xp: 5 },
  { mob: 'Eye', real: 'guardian', drops: ['prismarine shards', 'prismarine crystals', 'raw cod'], rare: [], xp: 10 },
  { mob: 'Big Eye', real: 'elder guardian', drops: ['wet sponge', 'prismarine shards'], rare: [], xp: 10 },
  { mob: 'Box', real: 'shulker', drops: ['shulker shell'], rare: [], xp: 5 },
  { mob: 'Sleep Police', real: 'phantom', drops: ['phantom membrane (slow falling potions, elytra repair)'], rare: [], xp: 5 },
  { mob: 'pimp', real: 'evoker', drops: ['totem of undying', 'emeralds'], rare: [], xp: 10 },
  { mob: 'Rhino', real: 'ravager', drops: ['saddle'], rare: [], xp: 20 },
  { mob: 'Wind Guy', real: 'breeze', drops: ['breeze rods (wind charges, mace)'], rare: [], xp: 10 },
  { mob: 'The Landlord’s Landlord', real: 'warden', drops: ['sculk catalyst'], rare: [], xp: 5 },
  { mob: 'The Big One', real: 'ender dragon', drops: ['a LOT of XP', 'dragon egg (first kill)'], rare: [], xp: '12,000 first kill' },
  { mob: 'Three Heads', real: 'wither', drops: ['nether star (beacon)'], rare: [], xp: 50 },
]
